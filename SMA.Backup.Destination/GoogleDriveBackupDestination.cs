...
{
    public class GoogleDriveBackupDestination : IGoogleDriveBackupDestination
    {
        private readonly ICommonUtil _commonUtil;
        private readonly ILogger _logger;
        private GoogleDriveConfiguration _configuration;

        public GoogleDriveBackupDestination(ICommonUtil commonUtil)
        {
            _commonUtil = commonUtil;
        }

        public Task<OutputModel> Upload(IBackupDestinationConfiguration destinationConfiguration)
        {
